...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        $user = $request->validate(
            ...
            [
                ...
                'fname.min' => 'Full Name must be at least 10 characters',
        ...
        return back()->with('success', 'The User Is Created Successfully');
    }
    /**
    ...
    public function update(Request $request, string $id)
    {
        ...
        $new_user = $request->validate(
            ...
            $user->image = $imageName ;
            $user->save() ;
            return redirect()->route('admin.users')->with('success', 'The User Is Updated Successfully');
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.users')->with('danger' , 'The User is Deleted Successfully') ;
    }
}
