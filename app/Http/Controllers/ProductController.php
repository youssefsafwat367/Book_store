...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', 'The Product Is Created Successfully');
    }
    /**
    ...
    public function show(string $id)
    {
        ...
        if (auth()->user() != NULL) {
            ...
            return view('front.single-product', ['product' => $product, 'branches' => $branches, 'related_products' => $related_products, 'carts' => $carts , 'categories'=>$categories]);
        } else {
            return view('front.single-product', ['product' => $product, 'branches' => $branches, 'related_products' => $related_products , 'categories'=>$categories]);
        }
    }
    /**
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.products')->with('success', 'The Product Is Updated Successfully');
    }
    ...
    public function destroy(string $id)
    {
        ...
        $product->delete() ;
        return redirect()->route('admin.products')->with('danger' , 'The Product is Deleted Successfully') ;
    }
}
